...
document.addEventListener("drop",e=>{e.preventDefault();addFiles([...e.dataTransfer.files].filter(f=>f.type.startsWith("audio/")))});
function addFiles(files){
 files.filter(f=>f.type.startsWith("audio/")).forEach((f,i)=>{
